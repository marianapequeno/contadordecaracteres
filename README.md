...
### Funcionalidades: 
* [x] Ao digitar ou colar palavras na caixa de texto, informa a quantidade de caracteres e de palavras digitadas/coladas.
...
1. Clone este repositório: `git clone https://github.com/marianapequeno/contadordecaracteres.git`
2. Entre no diretório: `cd contadordecaracteres`